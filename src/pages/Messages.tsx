...
export default function Messages() {
  ...
  const pendingMessages = messages.filter((m) => m.direction === "outbound" && !m.delivered_at);

  const deliveredMessages = messages.filter((m) => m.direction === "outbound" && m.delivered_at);
    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Mensagens enviadas e recebidas via WhatsApp</p>
        </div>
        ...
        <div className="glass-card rounded-xl overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">As mensagens enviadas e recebidas aparecerão aqui</p>
            </div>
          ) : (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {message.is_ai_generated && (
                          <span className="text-xs bg-purple-500/10 text-purple-400 px-2 py-0.5 rounded">IA</span>
                        )}
                        {message.template_id && (
                          <span className="text-xs bg-muted text-muted-foreground px-2 py-0.5 rounded">Template</span>
                        )}
